...
const componentMode='departures'
    return (
        <li 
        className="flights-navigation__item" onClick={()=>changeFlightsMode(componentMode)}>
        <a href="#" className={classNames({'flights-navigation__item_active':(mode===componentMode)})} target="_self">
          <span className="icon">
            <svg
              width="40px"
              height="28px"
